...
def judge_articles_batch(articles: List[ArticleDict]) -> List[ArticleDict]:
    """
    Evaluate a batch of articles with the Judge Agent and sort by
    score_global descending.
    ...
    """
    print(f"\n⚖️ [ReAct Judge] Evaluating {len(articles)} articles...")
    ...
    for i, art in enumerate(articles):
        ...
        print(f"     -> Global Score: {scored['score_global']}/100 | Decision: {scored['decision']}{flag}")
